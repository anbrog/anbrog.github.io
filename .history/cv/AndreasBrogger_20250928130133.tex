...
\item[\textbf{2024}] American Finance Association Annual Meeting (AFA), Utrecht University, Dutch Sustainable Finance Workshop, International Centre for Pension Management (ICPM)  Discussion Forum, European Finance Association Annual Meeting (EFA), Erasmus University (EUR), Vrije Universiteit Amsterdam (VU), Cambridge University Judge Business School, Robeco Investment Engineers\\[-1ex] %, Maastrict (s), RBN-AMRO (s), VU, Lux?
